...
inline size_t from_base64(const void* src, size_t srcLen, void* dst, size_t dstLen) {
    ...
    for (size_t i = 0; i < origLen; i += 4) {
        out[outLen++] = base64_lut2[data[i+0]][0] | base64_lut2[data[i+1]][1];
        out[outLen++] = base64_lut2[data[i+1]][2] | base64_lut2[data[i+2]][3];
        out[outLen++] = base64_lut2[data[i+2]][4] | base64_lut2[data[i+3]][5];
    }
